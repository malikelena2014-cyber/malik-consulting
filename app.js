...
window.openContact=()=>showPanel('contactModal');window.closeContact=()=>hidePanel('contactModal');window.openTestimonial=i=>showPanel('testimonial-'+i);window.closeTestimonial=i=>hidePanel('testimonial-'+i);
